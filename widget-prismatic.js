    ...
    return {
        ...
        chopMesh: function () {
            ...
            for (let i = 0; i < objectTriangles.planes.length; ++i) {
                let plane = objectTriangles.planes[objectTriangles.planes.length - i - 1];
                this.meshWidget.addMeshFromPaths(plane.paths, plane.z, this.scale, { color: 0x800000 }, { name: objectMesh.name + ': cut plane ' + i });
            }
        },
